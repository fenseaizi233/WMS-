...
public class ScrewGenerator {
    ...
    static void documentGeneration() {
        ...
        hikariConfig.setJdbcUrl("jdbc:mysql://localhost:3306/wmstore1?useUnicode=true&characterEncoding=UTF8&useSSL=false");
...
//                        .fileName("基于springboot+vue的共享单车时空地图综合管理平台系统数据库文档")
                        .fileName("基于SpringBoot+Vue前后端分离的仓库管理系统数据库文档")
                        .build();
