<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="inrecord" label="货物名称" width="100">
      ...
      <el-table-column prop="inrecord" label="货物分类" width="100">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    delHandle(id) {
      ...
      console.log(ids);
      this.$confirm("将删除入库一切有关数据， 是否继续?", "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
        .then(() => {
          this.$axios
            .post(this.$httpUrl + "/inrecord/deleteBatch", ids, {
              headers: {
