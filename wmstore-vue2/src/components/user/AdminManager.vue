<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="name" label="管理员昵称" width="120">
      </el-table-column>
      <el-table-column
        prop="password"
        label="管理员密码"
      ...
      >
        <el-row>
          <el-col :span="12">
            ...
            <el-form-item label="管理员手机号" prop="telephone">
            ...
            <el-form-item label="管理员性别" prop="sex">
              <el-select v-model="form.sex" placeholder="请选择管理员性别">
                <el-option
                  v-for="item in sexData"
                  :key="item.id"
                  :label="item.name"
          ...
          <el-col :span="12">
            <el-form-item label="管理员头像" prop="avatar">
              <div class="image-show" v-if="imgUrl">
                <!-- <el-avatar :src="imgUrl" v-if="!ismod" :size="200"> </el-avatar>
                <el-avatar
                :size="200"
                  :src="'http://localhost:8844/upload/avatar/' + form.avatar"
                  v-if="ismod"
                >
                </el-avatar> -->
